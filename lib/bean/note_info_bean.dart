class NoteInfo {
  ...
  set handleAccountId(String handleAccountId) =>
      _handleAccountId = handleAccountId;
  ...
  set themeBookListId(String themeBookListId) =>
      _themeBookListId = themeBookListId;
  ...
  NoteInfo.fromJson(Map<String, dynamic> json) {
    ...
    if (json['img'] != null) {
      _img = <Img>[];
      json['img'].forEach((v) {
        _img?.add(new Img.fromJson(v));
      });
    }
    _preloadUser = json['preload_user'] != null
        ? new PreloadUser.fromJson(json['preload_user'])
        : null;
    ...
    _relationData = json['relation_data'] != null
        ? new RelationData.fromJson(json['relation_data'])
        : null;
    ...
    _topicData = json['topic_data'] != null
        ? new TopicData.fromJson(json['topic_data'])
        : null;
  }
